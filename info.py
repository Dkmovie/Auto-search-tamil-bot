...
STREAM_URL = environ.get("STREAM_URL", "https://serene-atoll-96451-a88bf904e99a.herokuapp.com/") # https://example.com/ (Your Stream Url)
...
MULTI_CLIENT = False
name = str(environ.get('name', 'filetolinkbot'))
